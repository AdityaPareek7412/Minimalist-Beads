      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            onClick={onClose}
            className="fixed inset-0 bg-[#2d111a]/60 backdrop-blur-sm z-[60]"
          />
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 w-[85%] max-w-sm bg-[#2b0013] text-white z-[70] shadow-2xl flex flex-col overflow-hidden"
          >
