      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20 bg-white p-6 sm:p-10 rounded-[2rem] shadow-sm border border-pink-100">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl font-sans font-bold text-gray-900 mb-4 leading-tight tracking-tight">
              {product.name}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <div className="flex items-center bg-pink-50/50 border border-pink-100 rounded-full p-1.5 shadow-inner">
                <button
              ...
              >
                <ShoppingBag size={18} />
                {isAdded ? "ADDED TO MAGIC" : "ADD TO CART"}
              </button>
            </div>
